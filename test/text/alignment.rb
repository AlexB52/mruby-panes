    ...
    def test_right_alignment_single_line
      ...
      assert_commands([
        ...
        },
        {
          ...
          type: :text,
          text: 'Hi',
          bounding_box: { x: 8.0, y: 0, width: 2, height: 1 },
          bg_color: 0,
          fg_color: 0,
        },
      ], commands)
    ...
    def test_center_alignment_with_wrapping
      ...
      assert_commands([
        ...
        },
        {
          ...
          bounding_box: { x: 1.0, y: 0, width: 18, height: 1 },
          bg_color: 0,
          fg_color: 0,
        },
        {
          ...
          type: :text,
          text: 'five',
          bounding_box: { x: 8.0, y: 1, width: 4, height: 1 },
          bg_color: 0,
          fg_color: 0,
        },
      ], commands)
    ...
    def test_inline_text_alignment_to_right
      ...
      assert_commands([
        ...
        },
        {
          ...
          type: :text,
          text: 'abc def ghi jkl',
          bounding_box: { x: 1.0, y: 0, width: 15, height: 1 },
          bg_color: 0,
          fg_color: 0,
        },
        {
